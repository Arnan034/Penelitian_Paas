...
ActiveRecord::Schema.define(version: 2023_11_01_160721) do
  ...
  create_table "BantuanDanaBeasiswa", primary_key: "bantuan_dana_beasiswa_id", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["mahasiswa_id"], name: "fk_rails_c1687c2c2d"
    t.index ["penggalangan_dana_beasiswa_id"], name: "fk_rails_4eb1853b0d"
  end
  ...
  create_table "Mahasiswa", primary_key: "nim", id: { type: :string, limit: 9 }, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "nama"
  ...
  create_table "PenggalanganDanaBeasiswa", primary_key: "penggalangan_dana_beasiswa_id", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["penanggung_jawabs_role"], name: "fk_rails_65f632129d"
  end
  ...
  add_foreign_key "BantuanDanaBeasiswa", "Mahasiswa", column: "mahasiswa_id", primary_key: "nim"
